...
export function CategoryCard({
  ...
  const visual = product ? (
    ...
    <DesignItem item={component} size={compact ? 52 : 76} />
  ) : null;
  return (
    <Pressable
      ...
      onPress={() =>
        router.push({
          pathname: product ? '/products' : '/components',
      ...
      style={({ pressed }) => [
        ...
        compact
          ? { width: '31%', alignItems: 'center', gap: 7 }
          : {
              minHeight: 132,
              flexDirection: 'row',
              alignItems: 'center',
      ...
      {compact ? (
        ...
        <>
          <View style={{ flex: 1, gap: 7 }}>
            ...
            <Text style={ui.caption}>{category.description}</Text>
          </View>
